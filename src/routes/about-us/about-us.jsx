...
const About = () => {
  return (
    <div>
      <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">About Us</h2>
      <p className=" text-justify my-4 text-zinc-700">
      ...
      <img className="h-20 mx-auto" src={Logo} alt="web-site-logo" />
    </div>
  );
};
